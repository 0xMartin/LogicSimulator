 ...
 * @author Martin
 */
public class RaisingEdgeDetector extends WorkSpaceObject {

    private final IOPin in, out;

    public RaisingEdgeDetector(Point position, int bits) {
        super(position);
        //model
    ...
    @Override
    public RaisingEdgeDetector cloneObject() {
        RaisingEdgeDetector ret = new RaisingEdgeDetector(
