 ...
 * @author Martin
 */
public class SerialInputTrigger extends WorkSpaceObject implements SerialIO {

    //if value of pin changed -> true
    ...
    public SerialInputTrigger(Point position, String id) {
        super(position);

        //g string id
        this.ID = new GString(new Point2D.Double(
                -25 - id.length() * Fonts.MEDIUM.getSize() / 2, 0),
        ...
        //output pin
        this.pin = new IOPin(IOPin.MODE.OUTPUT, 1, "TRIGGER OUT", new Point.Double(14, 0));
    ...
    public WorkSpaceObject cloneObject() {
        return new SerialInputTrigger(Tools.copy(super.getPosition()), this.ID.getString());
    }
