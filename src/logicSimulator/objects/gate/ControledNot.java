 ...
 * @author Martin
 */
public class ControledNot extends WorkSpaceObject {

    protected final IOPin IN, OUT, CONTROL;

    protected int bits;

    public ControledNot(Point position, int bits) {
        super(position);
    ...
    @Override
    public ControledNot cloneObject() {
        ControledNot ret = new ControledNot(Tools.copy(super.getPosition()), this.bits);
